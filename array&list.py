...
def menu():
    print("[1, 22, 12, 32, 42, 52, 62, 72, 82, 92]\n")
...
while True:
    try:
        ...
        if choice in (1, 2, 3, 4, 5, 6):
            if choice == 1:
                list1 = [1, 22, 12, 32, 42, 52, 62, 72, 82, 92]
                list1.append(11)
                ...
                insert = int(input("Where do you want it to insert: "))
                item = int(input("Enter the number you want to to insert: "))
                list1 = [1, 22, 12, 32, 42, 52, 62, 92]
